...
mun_mp_tbl <- function(data, dataframe = FALSE) {
  ...
  if(dataframe == TRUE) {
    result <- list(Group1 = filter(data, mp_criteria == "< 3.0" & mun_criteria == "< 12"),
         ...
         Group3 = filter(data, mp_criteria == "< 3.0" & mun_criteria == "18 <") ,
         ...
         Group7 = filter(data, mp_criteria == "3.4 <" & mun_criteria == "< 12") ,
         Group8 = filter(data, mp_criteria == "3.4 <" & mun_criteria == "12-18") ,
